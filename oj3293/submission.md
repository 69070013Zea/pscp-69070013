...
```text
โจทย์ให้รับค่า5ค่ามา
จากนั้นนำไปครอบโดยบรรทัดแรกและบรรทัดสุดท้ายจะเป็นความยาวของตัวอักษรที่ยาวที่สุดบวกกกับ4(มาจากที่แต่ละบรรทัดจะต้องเริ่มด้วยและจบด้วย”* ”)บรรทัดที่เหลือจะเป็นข้อความตามลำดับ
```
...
```text
Step1:สร้างdictว่าง
2.ใช้for loop 5รอบเพื่อรับtextและส่งtextพร้อม(key)กับLenของtext(value)ขึ้นdict
3.หาค่าสูงสุดของvalueในdict
4.ตั้งความยาวสูงสุด=maxของvalue+4
5.พิมบรรทัดหัวด้วย”*”คูณความยาวสูงสุด
6.ใช้forloopกับdictเพื่อพิมข้อความในdictโดยใส่ตัวขึ้นหน้าและปิดหลังด้วยความยาวสูงสุด-4-ความยาวตัวนั้น
7.ทำเหมือนข้อ5.เพื่อเป็นบรรทัดสุดท้าย
```
...
```text
Step1:สร้างlist ว่างขึ้นมาสองอัน
2.ใช้for loop 5รอบเพื่อรับtextและไปเก็บในlistอันนึงและส่งlentextไปเก็บในอีกอัน
3.ใช้maxกับlistที่มีlentextอยู่
4.ตั้งความยาวสูงสุด=ค่าmax+4
5.พิมบรรทัดหัวด้วย”*”คูณความยาวสูงสุด
6.ใช้forloopกับlisttextเพื่อพิมข้อความโดยใส่ตัวขึ้นหน้าและปิดหลังด้วยความยาวสูงสุด-4-ความยาวตัวนั้น
7.ทำเหมือนข้อ5.เพื่อเป็นบรรทัดสุดท้าย
```
...
```text
ตัวอย่างให้มา ตำแหน่งอาจไม่ตรงเนื่องจากพิมในipad
```
