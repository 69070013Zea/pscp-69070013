...
```text
โจทบ์ให้รับค่ามาค่านึง แล้วหาค่าบริการโดยต่ำสุดที่50และมากสุดที่1000 จากนั้นนำค่าที่รับกับค่าบริการบวกกันแล้วนำไปคิดvat
Input:
รับค่าfloatหนึ่งค่า

Output:
คำณวณค่าจากนั้นพิมพ์ออกมาในรูปทศนิยมสองตัว

Constraints:
โจทย์ต้องการพิมพ์ในรูปควรใช้f string เพื่อใส่:.2f เพื่อทำให้ปริ้นในรูปแบบทศนิยมสองตำแหน่ง
...
```text
Step 1: รับค่าอาหาร
Step 2: นำไปคูณ10/100เพื่อได้ค่าบริการ
Step 3: หากค่าต่ำกว่า50เปลี่ยนค่าเป็น50
Step 4:หากค่ามากกว่ากว่า1000เปลี่ยนค่าเป็น1000
Step 5:นำค่าอาหารมาบวกกับค่าบริการ
Step 6:นำค่าไปหาVATด้วยการคูณ107/100
Step 7:พิมท์ค่าที่หาVATแล้วในรูปแบบf string ที่ทำให้เป็นทศนิยมสองตำแหน่ง
```
...
```text
เหมือนวิธีแรกเพราะลองใช้เทสเคสต่างๆแล้วไม่พบปัญหาอะไร มีเพิ่มเต็มแค่แก้pep-8
```
...
```text
ทดสอบเมื่อค่าบริการมากกว่า1000
```
