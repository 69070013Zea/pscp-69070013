...
```text
โจทย์ให้รับค่าก้อนเล็กก้อนใหญ่(*5)และขนาดสะพานตามลำดับจากนั้นให้ใช้ก้อนใหญ่ให้หมดหรือใช้ต่อไม่ได้เพราะขนาดจะเกินแล้ว จึงใช้ก้อนเล็กต่อ พิมพ์จำนวนที่น้อยที่สุดของก้อนเล็กที่ใช้แล้วสร้างสะพานได้ตามเป้าหมาย
input:รับค่าก้อนเล็กใหญ่ และขนาดสะพานคนละบรรทัดตามลำดับ
output:พิมพ์ก้อนเล็กที่ใช้น้อยที่สุดเท่าที่เป็นไปได้
constraints:ควรหาวิธีมาจัดการกับอิฐก้อนใหญ่ที่เกินไปเยอะโดยการ%
```
...
```text
Step 1: รับค่าทั้งสามค่า
Step 2: นำขนาดมาลบด้วยอิฐใหญ่
Step 3: ถ้าขนาดน้อยกว่าเท่ากับก้อนเล็กพิมพ์ให้พิมพ์ ขนาด นอกนั้นพิมพ์-1
...
```text
Step 1: รับค่าทั้งสามค่า
step2: ตรวจว่าก้อนใหญ่มากกว่าขนาดให้ขนาด%5 นอกนั้นนำขนาดมาลบด้วยอิฐใหญ่
Step 3: ตรวจว่าถ้าขนาดน้อยกว่าเท่ากับก้อนเล็กพิมพ์ให้พิมพ์ ขนาด นอกนั้นพิมพ์-1
```
