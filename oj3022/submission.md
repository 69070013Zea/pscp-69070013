...
```text
input:โจทย์ให้รับค่ามาสามค่า ค่าที่หนึ่งเป็นตัวเลขของอุณหภูมิเริ่มต้น ค่าที่สองเป็นตัวอักษรแทนหน่วยของอุณหภูมิเริ่มต้น ค่าที่สามเป็นตัวอักษรแทนหน่วยของอุณหภูมิหลัง
Output:พิมพ์อูณหภูมิที่แปลงค่าแล้วในแบบทศนิยม2ตำแหน่ง
constraints:โจทย์ต้องการทศนิยมสองตำแหน่ง ควรใช้f string
```
...
Step 2: ตรวจดูว่าอุณหภูมิเริ่มต้นเป็นค่าหน่วยอื่นที่ไม่ใช้่Cไหมฉากใช้ให้แปลงจากหน่วยนั้นมาเป็นC
Step 3: ตรวจดูว่าอุณหภูมิหลังเป็นค่าหน่วยอื่นที่ไม่ใช้่Cไหมฉากใช้ให้เปลี่ยนเป็นหน่วยนั้น
Step 4: พิมพ์อุณหภูมิ
```
...
```text
เหมือนแผนแรกแต่มีการแก้ในส่วนสมการการแปลงหน่วยอุณหภูมิ
```
