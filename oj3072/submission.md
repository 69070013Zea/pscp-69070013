...
```text
โจทย์ให้รับข้อความเข้าแล้วlowercaseจากนั้นนำไปแยกสระแล้วจึงพิมพ์ในรูปแบบ a : จำณวณa เป็นต้น
Input:
รับความความ

Output:
พิมพ์ในรูปแบบ a : จำณวณa

Constraints:
เป็น case not sensitive จึงใช้lowerกับข้อความเพื่อการแยก
```
...
```text
Step 1:รับค่าข้อความจากนั้นใช้function ในการเปลี่ยนข้อความเป็นlowercase
Step 2:สร้างarrayที่มีสระ(sara)กับarrayว่าง(sara_in_word)
Step 3:คัดแยกสระด้วยfor หากมีสระให้เพิ่มสระเข้าไปในarrayว่าง
Step 4:ถ้าหากมีสระใน(sara_in_word)พิมพ์ในรูป สระ : จำนวนสระ โดยจำนวนจะมาจาก sara_in_word.count(สระ) ทำอย่่างนี้กับสระทุกตัว
```
...
```text
แนวคิดเหมือนวิธีแรกแต่ใช้การforloopในstepสุดท้ายเพื่อลดภาระในการพิมพ์
```
