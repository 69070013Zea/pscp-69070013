...
```text
ตัวโจทย์ให้รับinputสีสองรอบ ถ้าเป็นสี "Red","Blue","Yellow"  จะปริ้นออกมาเป็นสีที่ผสมแล้วระหว่างสองสี
input:
โปรแกรมรับค่าสีสองครั้งที่1และ2

output:
โปรแกรมจะprint "Violet"หากinputเป็น"Blue"และ"Red"สลับกันได้
print "Orange"หากinputเป็น"Yellow"และ"Red"สลับกันได้
print "Green"หากinputเป็น"Yellow"และ"Blue"สลับกันได้
นอกเสนอจากนี้print"Error"

Constraints:
สีมีสีอื่นด้วยแต่เราต้องการแค่แม่สี
...
step 2:ถ้าเป็น แดงกับฟ้า หรือฟ้ากับแดง พิมพ์ Violet
step 3:ถ้าเป็น เหลืองกับฟ้า หรือฟ้ากับแหลือง พิมพ์ Green
step 4:ถ้าเป็น เหลืองกับแดงหรือแดงกับแหลือง พิมพ์ Orange
step 5:หากไมม่ใช่เลย พิมพ์ Error

ก่อนถามเพื่อนผมไม่คิดว่าสีเดียวผสมกันได้สีเดิม
```
...
```text
เหมือนกันแผนแรกแต่เพิ่มการผสมสีเดียวกันไปด้วยเช่น RedกับRedพิมพ์Red เป็นต้น
```
...
```text
เทสว่าทำสีตามโจทย์ ได้ถูกต้องหรือไม่
```
...
```text
เทสว่าสีนึงไม่ใช่แม่สีแต่อีกสีเป็น ได้outputถูกไหม
```
...
```text
เทสว่าสีนึงไม่ใช่แม่สีทั้งสองสี ได้outputถูกไหม
```
...
```text
เขาบอกผมว่า แม่สีสีเดียวกันจะได้สีนั้น
```

คุณยังทำอะไรด้วยตนเอง

```text
เขียนเงื่อนไขเพิ่มจากข้อมูลที่ได้จากเพื่อน
```
