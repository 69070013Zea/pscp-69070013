...
```text
รับค่ามาทั้งหมด4ค่า โดยโจทย์ให้หาจำนวนตัวเลขระหว่างค่าแรกถึงค่าสอง ที่หารด้วยค่าสามแล้วเหลือเศษค่าที่สี่แล้วพิมพ์ออกมา
Input:
รับค่ามาสี่ค่าโดยแต่ละค่าอยู่คนละบรรทัด
Output:
ตัวเลขที่เป็น จำนวนตัวเลขระหว่างค่าแรกถึงค่าสอง ที่หารด้วยค่าสามแล้วเหลือเศษค่าที่สี่
Constraints:
ค่าสองและค่าสี่ควรจะมากกว่าค่าหนึ่งและสามตามลำดับ
```
...
```text
Step1:รับค่าจำนวนแรก,จำนวนท้าย,ตัวหาร,ตัวเศษตามลำดับคนละบรรทัด
Step2:สร้างตัวแปรไว้นับ
Step3:ใช้for Iใน ระหว่างrange(ตัวแรก,ตัวท้าย+1)/ตัวหารแล้วได้เศษเท่ากับตัวเศษไหมหากเท่าให้ตัวแปรนับ+1
Step4:พิมพ์ตัวแปรนับ
```
...
```text
เหมือนกับแผนแรก ตัวผม+1ตัวท้ายเพื่อเท่าให้จำนวนท้ายสุดในrangeเท่ากับตัวท้าย
```
