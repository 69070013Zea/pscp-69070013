...
```text
รับค่าจำนวนเต็ม nมาแล้วหาว่าตั้งแต่nถึง0มีกี่ตัวที่หาร10ลงตัวแล้วพิมพ์ในบรรทัดเดียว กัน โดยแต่ละตัวเว้นหนึ่งช่อง
input:รับค่าจำนวนเต็ม n
Output:พิมพ์ตัวเลขทั้งหมดที่หาร10ลงตัวในบรรทัดเดียวโดยมีช่องว่างเว้นแต่ละตัว
Constraints:การพิมพ์บรรทัดเดียวโดยมีช่องว่างเว้นแต่ละตัว จะต้องใช้ฟังก์ชัน end
```
...
```text
Step 1: รับค่าจำนวนเต็มบวกnum
Step 2: สร้างrange(num//10+1)เป็นrnum
Step 3: ใช้ for loop ตามจำนวนi โดย i คือ rnumย้อนกลับ ในloop จะพิมพ์i*10 และใช้endเพื่อคงบรรทัดและเว้นแต่ละตัว
...
```text
เหมือนวิธีแรก แต่เพิ่ม[::-1]หลังrnumใน loopเพราะลืม
```
