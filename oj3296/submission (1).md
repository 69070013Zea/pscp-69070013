...
```text
โจทย์ให้รับค่าสรมาสองสีแล้วเอาไปผสมกัน
Input:
รับค่าสีมาด้วยlistmapในค่าintทั้ง2สี
Output:
พิมค่าสีที่รวมแล้ว
Constraints:
ใช้*หน้่าlistเมื่อพิมจะพิมโดยไม่มีกรอบ
```
...
```text
Step 1: รับค่าสีทั้งสองเปล่ยนเป็นintในlist
Step 2: นำintในlistทั้ง2ในตำแหน่งเดียวกันมาบวกกันแล้ว//ก่อนจะเพิ่มลงในอีกlistที่สาม
Step 3: *พิมlist3
