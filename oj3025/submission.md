...
```text
โจทย์ให้รับค่าข้อมูลวันที่และเดือน โดย1-3เป็นwinter 4-6เป็นspring 7-9เป็นsummer10-12เป้นfall โดยหากวันที่มากกว่า21และเป็นเดือนที่3ของฤดูจะ นับเป็นฤดูนัดไป
Input:
โปรแกรมรับ ค่า เดือน พร้อม วันที่ ตามลำดับ
Output:
winter(1-3) spring(4-6) summer(7-9)fall (10-12)
Constraints:
เดือนมี12เดือนหากเดือนเกินควรนำมาลบ12
```
...
```text
Step 1: รับค่าเดือนและวันตามลำดับ
Step 2:นำค่าไปแยกด้วยsplitและสร้างตัวแปลแยกให้ทั้งคู่
Step 3: ถ้าวันมากกว่าเท่ากับ21 เดือน+=1
Step:4ถ้าเป็นเดือน1-3พิมพ์winter ถ้าเป็นเดือน4-6พิมพ์springถ้าเป็นเดือน7-9พิมพ์summerถ้าเป็นเดืน10-12พิมพ์fall
```
...
```text
เหมือนกับอันแรกแต่มีเพิ่มถ้าเดือนมากกว่า12นำดเือนมาลบกับ12 ระหว่างstep3กับ4เพื่อจัดการเดือนที่เกิน 12
```
