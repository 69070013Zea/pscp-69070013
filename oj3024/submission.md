...
```text
โจทย์ให้รับค่าสองค่าโดยค่ารวมของผลโหวดคะแนนของทั้ง3คนและค่าผลโหวตที่มีค่ามากที่สุดคนละบรรทัดโดยโจทย์ต้องการให้ตรวจหาว่าถ้าค่าผลโหวดที่มากมากกว่าที่สุดน้อยกว่าสองหรือมากกว่าให้พิมพ์surprising นอกนั้นให้พิมพ์not surprising 
Input:
ให้รับค่าทั้งสองค่าคนละบรรทัด(float)
Output:
ถ้าความต่างเป็น2หรืมากกว่าsurprisingนอกนั้นnot surprising
Constraints:
ค่าผลโหวตแต่ละคนอยู่ละหว่าง0-10
```
...
```text
Step 1: รับค่าทั้งสองค่าคนละบรรทัด
Step 2: หาค่าต่ำสุดด้วยการนำค่ารวมมาลบด้วยค่าสูงสุดคูณสอง
Step 3: ตรวจหาว่าค่าสูงสุดมากกว่าต่ำสุดสองหรือมากกว่าถ้าใช้พิมพ์surprisingนอกนั้นพิมพ์not surprising
```
...
```text
เหมือนกับcodeแรกโดยเพิ่มการใช้maxเพื่อจัดการค่าต่ำสุดกรณีค่าการเป็นติดลบ
```
