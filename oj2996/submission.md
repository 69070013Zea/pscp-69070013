...
```text
โจทย์ให้รับข้อความไม่เกินห้าตัวมาจากนั้นนำมาlowerแล้วเรียงกลับหลังจากนั้นก็พิมพ์
Input:
รับค่าข้อความ(str)
Output:
พิมพ์ตัวข้อความพิมพ์เล็กที่เรียงจากหลีงมาหน้า
```
...
```text
ใช้เหมือนวิธีแรกสุด แต่นำขั้นตอนlowerไปรวมในบรรทัดรับข้อมูลเลย
```
